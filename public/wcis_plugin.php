    ...
    public function add_plugin_admin_head()
    {
        ...
        <script type="text/javascript">
            jQuery(document).ready(function ($) {
                ...
                jQuery('ul li#toplevel_page_WCISPlugin a').attr("href", "<?php echo($dashboard_url); ?>")
            });
        </script>
        <?php
    }
...
// 		}
    ...
    function get_isp_search_box_form($attr)
    {
        ...
        $action_url = esc_url_raw(home_url('/'));
        $premium_serp_enabled = false;
        $options = get_option('wcis_general_settings');
        if ($options && array_key_exists('serp_page_id', $options) && array_key_exists('is_serp_enabled', $options) && $options['is_serp_enabled']) {
            $action_url = esc_url_raw(str_replace(home_url(), "", get_permalink($options['serp_page_id'])));
        ...
        if (!get_option('wcis_user_email')) {
            ...
            <div id="fast-simon-admin-email" >
                ...
                <div class="fast-simon-popup-content" >
                    ...
                    <form class="fast-simon-form" method="post" action="<?php echo esc_url_raw(admin_url('admin-post.php')); ?>">
