...
Tags: woocommerce,search,product search,search filters,merchandising
...
Enhanced WooCommerce Search. Maximize your store sales & ROI with this easy-to-install plugin that will skyrocket your conversion rate instantly.

== Description ==
**Search, Filters & Merchandising for WooCommerce**, by Fast Simon is the leading shopping optimization platform for merchants. It drives eCommerce search, AI-powered merchandising, and personalization, based on shopper behavior, store inventory, data, and visual signals for thousands of fast-growing online merchants.
...
* Smart AutoComplete
* TurboLinks
* Mobile Optimized WooCommerce search
...
* A/B Testing
* Visual search and Complete-The-Look
...
* AB test your merchandising strategy
...
View plugin demo -  [View Demo](https://woocommerce.fastsimon.com/)
